...
public class SubjectCodeForgetDetails extends AppCompatActivity implements View.OnClickListener,OnTaskCompleted {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subject_code_forget_details);
    ...
    private void initUI() {
        back_getdetails = findViewById(R.id.back_getdetails1);
        getdetails=findViewById(R.id.btn_teacher_getdetails1);
        enrollno=findViewById(R.id.subcode_ED);
    ...
    public void onClick(View view) {
        switch(view.getId())
        {
            case R.id.back_getdetails1:
                finish();
                break;
            case R.id.btn_teacher_getdetails1:
                getUserDetails();
                break;
        }
    }
    ...
    public void getUserDetails() {
        ...
        databaseReference = firebaseDatabase.getReference("FacultyPassword").child("ERP" + enrollment);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                {
                    progress.dismiss();
                    Toast.makeText(SubjectCodeForgetDetails.this, "user not found", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(SubjectCodeForgetDetails.this, value, Toast.LENGTH_SHORT).show();
                    convertString(value);
                }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(SubjectCodeForgetDetails.this, "Fail to get data.", Toast.LENGTH_SHORT).show();
            }
        });
...
//        Toast.makeText(SubjectCodeForgetDetails.this,username, Toast.LENGTH_SHORT).show();
        sendDetails();
    }
    ProgressDialog progress;
    public void openProgressDialog() {
        progress = new ProgressDialog(SubjectCodeForgetDetails.this );
    ...
    public void sendDetails(){
        ...
        try
        {
            ...
            OkHttpHandler okHttpHandler=new OkHttpHandler(SubjectCodeForgetDetails.this, (OnTaskCompleted) SubjectCodeForgetDetails.this,null,"OTPSend");
        ...
        switch (TAG)
        {
            case "OTPSend":
                if(jsonObject.optBoolean("return"))
                {
                    ...
                    Toast.makeText( SubjectCodeForgetDetails. this,  jsonArray.get(0)+"", Toast.LENGTH_LONG).show();
                }
                else
                {
                    Toast.makeText( SubjectCodeForgetDetails. this,  "OTP sending failed", Toast.LENGTH_LONG).show();
                    progress.dismiss();
                }
                break;
        }
