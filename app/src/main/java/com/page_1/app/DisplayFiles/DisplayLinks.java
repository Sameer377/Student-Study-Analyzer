...
public class DisplayLinks extends AppCompatActivity {

//    dbr= FirebaseDatabase.getInstance().getReference().child("Database").child(teachingYear).child(SubjectName).child("Links");
